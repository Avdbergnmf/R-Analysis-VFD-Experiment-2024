...
mu_sliced <- get_full_mu_sliced(allGaitParams, allTargetParams, allQResults, categories, 60, avg_feet=FALSE, add_diff = TRUE)
...
Boxplots Sliced
=====================================
```{r, child='pages/page9_boxplots_sliced.Rmd'}
```
