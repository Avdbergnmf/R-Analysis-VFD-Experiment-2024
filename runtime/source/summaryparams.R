...
get_full_gait_mu <- function(data, allQResults, categories){
...
get_full_mu <- function(allGaitParams, allTargetParams, allQResults, categories) {
  ...
  # Join the columns
  muGait <- get_full_gait_mu(allGaitParams, allQResults, categories)
  muTarget <- get_full_target_mu(allTargetParams, allQResults, categories)
