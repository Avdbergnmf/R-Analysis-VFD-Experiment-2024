...
observe({
  ...
  updateSelectizeInput(session, "depVar", choices = numeric_cols , selected = "stepWidths.sd")
  updateSelectizeInput(session, "indepInterVars", choices = numeric_cols, selected = numeric_cols[1])
