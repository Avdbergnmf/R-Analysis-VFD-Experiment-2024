...
textInput("customModel", "Custom Model Formula: dependent_variable ~ ", value = "stepWidths.sd ~ VFD * (startedWithNoise + VEQ.total + IMI.total) + trialNumWithinCondition + (1 | participant)")
