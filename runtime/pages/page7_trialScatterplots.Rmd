...
checkboxInput("averageData_trial", "Average data across condition", value = TRUE)
checkboxInput("diffData_trial", "Calculate difference + means per participant", value = TRUE)
```
