...
Save rotations dataset under "./data_extra/rotations_kinematic_data.csv". If there already is a dataset here, remove it and restart the code before making any adjustments here (otherwise you are adjusting an already adjusted dataset).
```{r}
