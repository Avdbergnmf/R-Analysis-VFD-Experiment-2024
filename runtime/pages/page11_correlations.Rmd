...
observe({
  ...
  updateSelectizeInput(session, "xVar", choices = numeric_cols, selected = "diff_VEQ.total")
  updateSelectizeInput(session, "yVar", choices = numeric_cols, selected = "diff_stepWidths.sd")
})
