...
checkboxInput("processData", "Process Data for Conditions", value = TRUE)
...
observe({
  ...
  updateSelectizeInput(session, "xVar", choices = numeric_cols , selected = ifelse(input$processData, "diff_VEQ.total", "VEQ.total"))
  updateSelectizeInput(session, "yVar", choices = numeric_cols, selected = ifelse(input$processData, "diff_stepWidths.sd", "stepWidths.sd"))
})
